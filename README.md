...
This MQTT MediaPlayer is able to subscribe to different topics and for every topic there also exists an template.
...
- platform: multiroom-mqtt-mediaplayer
  ...
  song_title_topic: "musiccast_test/status/kitchen/player/title"
  song_artist_topic: "musiccast_test/status/kitchen/player/artist"
